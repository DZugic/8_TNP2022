...
\section{Zvuk}
  ...
  \begin{figure}[h]
    ...
    \begin{itemize}
        ...
        \item \textit{Delta modulacija} (eng. \textit{Delta modulation, DM}) – uzorci se ne razlikuju mnogog i potrebno je manje bitova nego kod PCM\cite{10.17632/rwbs7645hg.3}
    \end{itemize}
